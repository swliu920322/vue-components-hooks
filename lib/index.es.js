import { computed, unref, ref, watch, reactive, onUnmounted, defineComponent, nextTick, onMounted, pushScopeId, popScopeId, resolveComponent, openBlock, createBlock, createVNode, mergeProps, createSlots, renderList, renderSlot, withScopeId, withCtx, h, toDisplayString, Teleport, createCommentVNode } from 'vue';
...
function useMessage() {
    return {
        ...
        createConfirmTitle: ({ name, title = "确认操作", okType = "danger", }) => new Promise((resolve) => {
            createConfirm({
                iconType: "warning",
                title: title,
                content: h("div", [
