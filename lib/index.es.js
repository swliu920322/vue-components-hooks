import { computed, unref, ref, watch, onUnmounted, reactive, defineComponent, nextTick, onMounted, pushScopeId, popScopeId, resolveComponent, openBlock, createBlock, createVNode, mergeProps, createSlots, renderList, renderSlot, withScopeId, withCtx, h, toRef, toDisplayString, Teleport, createCommentVNode } from 'vue';
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (_ctx.getDataSourceRef.length)
    ? (openBlock(), createBlock(_component_BasicTable, {
        key: 0,
    ...
    : (openBlock(), createBlock(_component_AEmpty, { key: 1 }))
}
